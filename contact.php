...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <!-- <h1 class="text-light"><a href="index.html">Logo Here</a></h1> -->
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Products</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="kitchen.php">Marble</a></li>
  ...
  <main id="main">
    ...
    <div class="map-section">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3056.446462245701!2d-76.0637527843753!3d39.998473888893955!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c6470cb8762115%3A0x36226012d4805b9a!2sLincoln%20Hwy%20%26%20E%20Lincoln%20Hwy%2C%20Kinzers%2C%20PA%2017535%2C%20USA!5e0!3m2!1sen!2sin!4v1662616027518!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            <form action="contact_form.php" method="post" class="form_design">
              <p class="text-center">For any questions, please fill out the following form and we will contact you right away.</p>
              <br>
              <div class="row">
              ...
              <br>
              <div class="text-center"><button type="submit" class="btn btn-secondary" name="send_email">Send Message</button></div>
            </form>
          </div>
